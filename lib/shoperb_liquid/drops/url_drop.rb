  ...
  module Url
    ...
    class PostDrop < Base
      ...
      def auth_input
        ...
        %(<input type="hidden" name="authenticity_token" value="#{value}"> <input autocomplete="off" type="text" name="shoperb_first_last_name_1" value="" class="shoperb_authenticity_token" />
        <style>
